...
Skin-Lesion-Hierarchical-Pipeline/
│
├── deployment/                  # Final system used in the paper
│   ├── app.py                   # Flask API entry point
│   ├── pipeline_service.py      # End-to-end inference pipeline
│   ├── infer/                   # Segmentation & classification services
│   ├── utils/                   # ROI extraction utilities
│   ├── preprocess/              # Image preprocessing
│   ├── models/                  # Model definitions (weights excluded)
│   ├── uploads/                 # Runtime upload directory
│   ├── temp/                    # Temporary mask/ROI storage
│   └── requirements.txt
│
├── experiments/ (optional)      # Local experiments / notebooks
└── README.md

🖥️ System Requirements
Hardware

NVIDIA GPU recommended (tested on RTX 3050 / 3070 / 4050)
...
All models were trained from scratch by the authors using the ISIC 2018 datasets.
...
2. Binary Classification Model (Benign vs Malignant)
...
3. Multiclass Malignant Classification Model
...
git clone https://github.com/your-username/skin-lesion-hierarchical-pipeline.git
cd skin-lesion-hierarchical-pipeline
